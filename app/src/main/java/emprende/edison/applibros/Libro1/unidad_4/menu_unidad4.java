package emprende.edison.applibros.Libro1.unidad_4;
...
public class menu_unidad4 extends AppCompatActivity {

    ImageView imagen1,imagen2,imagen3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menu_unidad4);
...
//PARA QUE AL DAR CLIC A LA IMAGEN  SE PASE A LA SIGUIENTE VENTANA
        imagen1.setOnClickListener(v -> startActivity(new Intent(menu_unidad4.this, matrial_aprendizaje4.class)));
        imagen2.setOnClickListener(v -> startActivity(new Intent(menu_unidad4.this, area_interacciones4.class)));
        imagen3.setOnClickListener(v -> startActivity(new Intent(menu_unidad4.this, tarea_actividades4.class)));
