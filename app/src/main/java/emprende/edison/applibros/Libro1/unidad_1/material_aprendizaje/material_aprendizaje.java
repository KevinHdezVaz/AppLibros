package emprende.edison.applibros.Libro1.unidad_1.material_aprendizaje;
...
import emprende.edison.applibros.Libro1.unidad_1.material_aprendizaje.contenido.material_uno;
import emprende.edison.applibros.R;

public class material_aprendizaje extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_material_aprendizaje);
        ...
        list.setOnItemClickListener((adapterView, view, i, l) -> {
            if (i == 0) {
                startActivity(new Intent(material_aprendizaje.this, material_uno.class));
